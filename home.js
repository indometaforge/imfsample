...
const PIPELINE = [
  ...
  { key: 'sb_pending',   label: 'SB Pending',     href: 'ht.html',         color: 'warn' },
  { key: 'sb_wip',       label: 'Shot Blasting',  href: 'ht.html',         color: 'warn' },
...
const STAGE_RC_MAP = {
  ...
  ht:       ['ht_queue', 'sb_pending', 'sb_wip', 'ht_done'],
  hard:     ['hard_wip'],
...
const RC_STATUS = {
  ...
  sb_pending:   { l: 'SB Pending',   b: 'bdg-a' },
  sb_wip:       { l: 'Shot Blasting', b: 'bdg-a' },
  ht_done:      { l: 'HT Done',      b: 'bdg-g' },
